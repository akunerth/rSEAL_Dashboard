...
#DK Data
DKdata <- data.frame(read.csv(file = '/Volumes/psy-ctn/psy-ctn/SNAPLab/SNAP Projects/SEAL/00_rSEAL/02_rSEAL_Data/PreStudy/DK_Log/Raw_Data/DKLog_rSEAL_03DEC2020.csv'))
...
rownames(Source1) <- c('Unknown', 'DHS', 'WIC', 'Facebook', 'Craigslist', 'Staff Member')
...
lbls <- c('Unknown', 'DHS', 'WIC', 'Facebook', 'Craigslist', 'Staff Member')
