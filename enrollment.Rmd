...
cols <- c("Complete" = "#33a02c", "Opt-Out" = "#737373", "On-Track" = "1f78b4", "Warning" = "#ffff99", "Delinquent" = "#e31a1c", "NA"="#bdbdbd")
labels <- c("Consent","PostConsentStatus", "Survey 1", "Survey 2", "PDR2", "PDR3", "LENA D1 Diary", "LENA D1 Data","LENA D2 Diary", "LENA D2 Data", "Survey 3", "Survey 4", "PDR5", "PDR6", "LENA D3 Diary", "LENA D3 Data", "LENA D4 Diary", "LENA D4 Data")

p <- ggplot(data = Enrollment15, aes(x=Instrument, fill= forcats::fct_rev(Status))) + geom_bar() + 
# Creates stacked bar chart
scale_x_discrete(label=labels) + scale_fill_manual(values = cols)
