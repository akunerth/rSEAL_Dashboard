...
Wv1Comp<- ((Enrollment13.1$LENAD2DiaryStatus == "Complete" | Enrollment13.1$LENAD2DiaryStatus == "Opt-Out") & is.na(Enrollment13.1$DropOutStage))
Wv1Comp <- (length(grep("TRUE", Wv1Comp))) 
Wv1InProg<- (Enrollment13.1$LENAD2DiaryStatus == "NA" | Enrollment13.1$LENAD2DiaryStatus == "On-Track" | Enrollment13.1$LENAD2DiaryStatus == "Delinquent" | Enrollment13.1$LENAD2DiaryStatus == "Warning") & is.na(Enrollment13.1$DropOutStage)
...
Wv2InProg<- ((Enrollment13.1$FidelityDate > "2020-07-01") & (Enrollment13.1$LENAD4DiaryStatus == "NA" | Enrollment13.1$LENAD4DiaryStatus == "Delinquent" | Enrollment13.1$LENAD4DiaryStatus == "Warning" | Enrollment13.1$LENAD4DiaryStatus == "On-Track") & Enrollment13.1$DropOutStage != 3)
