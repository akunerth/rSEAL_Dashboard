...
IntvInProg<- (is.na(Enrollment13.1$FidelityDate) & Enrollment13.1$LENAD2DiaryStatus == "Complete" | Enrollment13.1$LENAD2DiaryStatus == "Opt-Out") & is.na(Enrollment13.1$DropOutStage)
