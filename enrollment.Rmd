...
Enrollment14$Status <- factor(Enrollment14$Status, levels = c("Complete", "Delinquent", "NA", "On-Track", "Warning"))
...
scale_fill_manual(values = c("#bdbdbd","#e31a1c","#ffff99", "#1f78b4", "#33a02c" ), labels = c("NA", "Delinquent","Warning", "On-Track", "Complete")) #Manually assigns colors
...
Wave1Counts <- kable(Wave1,
        col.names = c("Complete","On-Track", "Warning","Delinquent", "NA")) %>%
