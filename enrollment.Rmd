...
#Enrollment14$Status <- forcats::fct_relevel(Enrollment14$Status, "On-Track", after = 2)
...
scale_fill_manual(values = c("#bdbdbd","#737373","#e31a1c","#ffff99", "#1f78b4", "#33a02c" ), labels = c("NA", "Opt-Out","Delinquent","Warning", "On-Track", "Complete")) #Manually assigns colors
