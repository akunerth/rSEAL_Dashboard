...
Wv1Comp<- (Enrollment13.1$LENAD2DiaryStatus == "Complete" | Enrollment13.1$LENAD2DiaryStatus == "Opt-Out")
Wv1Comp <- (length(grep("TRUE", Wv1Comp)) - Wv1DropOut)
Wv1InProg<- ((Enrollment13.1$LENAD2DiaryStatus != "Complete" & Enrollment13.1$LENAD2DiaryStatus != "Opt-Out")) 
...
Wv2Comp<- ((Enrollment13.1$LENAD4DiaryStatus== "Complete"| Enrollment13.1$LENAD4DiaryStatus == "Opt-Out") & Enrollment13.1$CoachImpComplete > "2020-07-01")
Wv2Comp <- (length(grep("TRUE", Wv2Comp)) - (Wv2DropOut))
Wv2InProg<- ((Enrollment13.1$LENAD4DiaryStatus != "Complete" & Enrollment13.1$LENAD4DiaryStatus != "Opt-Out") & Enrollment13.1$CoachImpComplete > "2020-07-01") 
