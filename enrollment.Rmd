...
IntvCompletion <- Enrollment$IntvCompletion <- ifelse(Enrollment$CoachImpComplete > "2020-07-01", "Complete", "Incomplete")
```
...
Wv1DropOut <- (CaseProg$DropOutStage == 1)
...
IntvComp<- (IntvCompletion == "Complete")
IntvComp <- length(grep("TRUE", IntvCompletion))
IntvInProg<- (is.na(IntvCompletion) & LENAD2DiaryCompletion == "Complete")
IntvInProg <- length(grep("TRUE", IntvInProg))
IntvDropOut <- (CaseProg$DropOutStage == 2)
...
Wv2DropOut <- (CaseProg$DropOutStage == 3)
Wv2DropOut <- length(grep("TRUE", Wv2DropOut))
Wv3DropOut <- (CaseProg$DropOutStage == 4)
