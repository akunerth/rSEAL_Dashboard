...
CaseProg <- data.frame("RSID" = CaseProg$ExternalReference,
                        ...
                        "LENADW1D11Log_OptOut" = CaseProg$Q2_10_TEXT,
                        "LENAW1DD2Log_OptOut" = CaseProg$Q2_11_TEXT,
...
Enrollment14$Status <- factor(Enrollment14$Status, levels = c("Complete", "Delinquent", "NA", "On-Track", "Warning", "Opt-Out"))
...
Enrollment14$Status <- forcats::fct_relevel(Enrollment14$Status, "Opt-Out", after = 4)
...
scale_fill_manual(values = c("#bdbdbd","#fb9a99","#e31a1c","#ffff99", "#1f78b4", "#33a02c" ), labels = c("NA", "Opt-Out","Delinquent","Warning", "On-Track", "Complete")) #Manually assigns colors
...
Wave1Counts <- kable(Wave1,
        col.names = c("Complete","On-Track", "Warning","Delinquent","Opt-Out", "NA")) %>%
