...
author: 
date: "Last Updated: 3/4/2021, 1:15am"
output: 
  html_document:
    theme: flatly
    toc: TRUE
...
LENATracker1 <- data.frame(read.csv('~/Box/SEAL-r/rSEAL_Data/LENA_Data_w1.csv'))
LENATracker2 <- data.frame(read.csv('~/Box/SEAL-r/rSEAL_Data/LENA_Data_w2.csv'))
LENATracker3 <- data.frame(read.csv('~/Box/SEAL-r/rSEAL_Data/LENA_Data_w3.csv'))
...
PostConsentComp<- (Enrollment13.1$PostConsentStatus == "Complete")
PostConsentComp<- length(grep("TRUE", PostConsentComp))
PostConsentInProg<- (Enrollment13.1$PostConsentStatus != "Complete")
...
Wv1Comp<- ((Enrollment13.1$LENAD2DiaryStatus == "Complete" | Enrollment13.1$LENAD2DiaryStatus == "Opt-Out") & is.na(Enrollment13.1$DropOutDate))
Wv1Comp <- (length(grep("TRUE", Wv1Comp))) 
Wv1InProg<- (Enrollment13.1$LENAD2DiaryStatus == "NA" | Enrollment13.1$LENAD2DiaryStatus == "On-Track" | Enrollment13.1$LENAD2DiaryStatus == "Delinquent" | Enrollment13.1$LENAD2DiaryStatus == "Warning") & is.na(Enrollment13.1$DropOutDate)
...
IntvInProg<- (is.na(Enrollment13.1$FidelityDate) & Enrollment13.1$LENAD2DiaryStatus == "Complete" | Enrollment13.1$LENAD2DiaryStatus == "Opt-Out") & is.na(Enrollment13.1$DropOutDate)
...
Wv2InProg<- ((Enrollment13.1$FidelityDate > "2020-07-01") & (Enrollment13.1$LENAD4DiaryStatus == "NA" | Enrollment13.1$LENAD4DiaryStatus == "Delinquent" | Enrollment13.1$LENAD4DiaryStatus == "Warning" | Enrollment13.1$LENAD4DiaryStatus == "On-Track"))
Wv2InProg <- length(grep("TRUE", Wv2InProg)-(Wv1DropOut+Wv2DropOut + IntvDropOut))
