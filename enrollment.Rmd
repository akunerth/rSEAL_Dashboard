...
Enrollment1 <- Enrollment %>%
      ...
      mutate(
      ConsentStatus = case_when(is.na(Enrollment$InformedConsent) ~ "Delinquent",
      Enrollment$InformedConsent > start       ~ "Complete",
      TRUE                      ~ "NA"
      )
     )
...
Enrollment1.1 <- Enrollment1 %>%
      ...
      Test0 <= 7 & Test >= 3 & is.na(SubInfoActual) ~ "Warning",
