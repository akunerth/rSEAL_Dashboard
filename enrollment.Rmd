...
scale_fill_manual(values = rev(c("#33a02c","#737373" ,"#1f78b4","#e31a1c","#bdbdbd" #"#ffff99"
                                  
                             )), labels = rev(c("Complete", "Opt-Out", "On-Track", #"Warning",  
                                            "Delinquent", "NA"))) #Manually assigns colors
