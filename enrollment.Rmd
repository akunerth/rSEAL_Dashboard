...
Wv1Comp<-  (Enrollment15$LENAD2DiaryStatus == "Complete" | Enrollment15$LENAD2DiaryStatus == "Opt-Out")
Wv1Comp <- (length(grep("TRUE", Wv1Comp)) - Wv1DropOut)
Wv1InProg<- ((Enrollment13.1$LENAD2DiaryStatus != "Complete" & Enrollment13.1$LENAD2DiaryStatus != "Opt-Out") & Enrollment13.1$PostConsentStatus == "Complete") 
