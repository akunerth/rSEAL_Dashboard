...
CoachImp <- data.frame(read.csv('~/Dropbox (University of Oregon)/SEAL R01/_Remote SEAL/rSEAL_Data/Coach_Impressions_Form.csv'))
...
Enrollment$CoachImpCompletion <- ifelse(Enrollment$CoachImpComplete > "2020-07-01", "Complete", "Incomplete")
...
IntvComp<- (CoachImpCompletion == "Complete")
IntvComp <- length(grep("TRUE", IntvComp))

IntvInProg<- (is.na(CoachImpCompletion) & LENAD2DiaryCompletion == "Complete")
...
Enrollment14$Status <- factor(Enrollment14$Status, levels = c("Complete", "On-Track", "NA", #"Warning", 
"Delinquent", "Opt-Out"))
...
Enrollment14$Instrument <- factor(Enrollment14$Instrument, levels = c("ConsentStatus", "PostConsentStatus", "Surv1Status","Surv2Status","PDR2Status","PDR3Status", "LENAD1DiaryStatus","LENAD1DataStatus","LENAD2DiaryStatus","LENAD2DataStatus", "Surv3Status","Surv4Status","PDR5Status","PDR6Status", "LENAD3DiaryStatus","LENAD3DataStatus", "LENAD4DiaryStatus", "LENAD4DataStatus")) # Create categorical variable
...
scale_fill_manual(values = c("#bdbdbd","#e31a1c", #"#ffff99",
                             "#737373","#1f78b4", "#33a02c" ), labels = c("NA", "Delinquent",#"Warning", 
                                                                                "Opt-Out","On-Track", "Complete")) #Manually assigns colors
...
Wave1Counts <- kable(Wave1,
        col.names = c("Complete","On-Track", "Opt-Out",#"Warning",
                      "Delinquent", "NA")) %>%
