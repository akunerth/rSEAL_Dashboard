...
<center>
**Counts of dyads for both remote and in-person SEAL.** 
<center>
...
::: {}
```{r SEAL Numbers, echo = FALSE, fig.width=5, fig.height=4, message=FALSE, warning=FALSE}
par(mar = c(4, 4, .2, .1))
...
::: {}
```{r SEAL Numbers Plot, echo = FALSE, fig.width=5, fig.height=4, message=FALSE, warning=FALSE}
par(mar = c(4, 4, .2, .1))
